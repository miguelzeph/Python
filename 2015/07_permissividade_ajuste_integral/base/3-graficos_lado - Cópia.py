...
J = ((Vo/Zo)*(1+abs(gama)**(2.0)-2*abs(gama)*np.cos(2*d-Or))**(1.0/2.0))


#-------GRAFICO1 - V ----------------------------------------
ax1=plt.subplot(2,2,1)
plt.subplots_adjust(left=0.1, bottom=0.3)
k, =plt.plot(d,V,'b-',label='1')
...
Vobar.on_changed(update3)
Orbar.on_changed(update3)
Zobar.on_changed(update3)
