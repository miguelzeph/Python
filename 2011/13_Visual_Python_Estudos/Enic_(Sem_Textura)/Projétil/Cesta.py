...
chao = box (pos = (40,-1,0), size = (80,0.5,10),color = (1,1,0.8))
teto = box (pos = (40,41,0), size = (80,0.5,10),color = (1,1,0.8))

parede = box (pos=(80,20,0), size=(0.5,42,10))
parede2 = box (pos=(-1,20,0), size=(0.5,42,10))
