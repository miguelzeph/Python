...
speedOfSatellite = 800 # change this to how fast we think the satellite is going in m/s
...
while not finished:
    totalseconds += dt
    rate(100000) # a high number pretty much means go as fast as our computer can
