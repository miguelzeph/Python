...
def posic_estrela():
	...
	x=random.uniform(-100,100)*R+50
	y=random.uniform(-100,100)*R+50
	z=random.uniform(-100,100)*R+50
...
for i in range (0,n):
	...
	strela = sphere(pos = posic_estrela(),radius = radius_estrela() ,color=(0,0,1),material = materials.emissive)
#-----------------------------------------------------------------------------------------------------------------
