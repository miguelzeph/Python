...
#e1_x = np.arange(23.5,26.7,0.30)
#e2_x = np.arange(1,3.8,0.30)


#e1_x = np.arange(2.8,3.2,0.01)
e1_x = np.arange(3.2,3.6,0.01)
e2_x = np.arange(0,2,0.1)
...
for n in range(0,len(F)):
	...
	escrever = "%.4f	%.4f	%.4f	1	0\n"%(F[n],X_por_f_er[n],X_por_f_ei[n])
