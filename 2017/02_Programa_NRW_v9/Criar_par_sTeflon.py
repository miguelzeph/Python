...
d = 1.5e-3 #[m] #Espessura da amostra
...
plt.plot(F_grafic,S11_mod_c,label ="s11_linear_teorico")
plt.plot(F_grafic,S21_mod_c,label="s21_linear_teorico")
plt.plot(F_grafic,S11_mod,label ="s11_linear_exp")
plt.plot(F_grafic,S21_mod,label="s21_linear_exp")
plt.xlim(8.2,12.4)
plt.xlabel("Freq(GHz)")
plt.legend()
plt.show()
