...
d = 10e-3 #[m] #Espessura da amostra (Livro chama de L)
...
#Plot Modulo em DB
plt.plot(F_grafic,s11_db,'.b',label ='s11_experimental')
plt.plot(F_grafic,s21_db,"or",label = 's21_experimental')
...
#Plot Phase em Grau
plt.plot(F_grafic,s11_ph,'g.',label ='s11_phase',alpha=0.5)
plt.plot(F_grafic,s21_ph,'b.',label='s21_phase',alpha=0.5)
...
plt.plot(F_grafic,Z_ma,'-g',label ='Impedance_Theoric')
plt.plot(F_grafic,Z_m,'-r',label ='Impedance_Experimental') #Igual (MAS E MELHOR)
#plt.plot(F_grafic,Z_nrw,'-y',label ='z_nrw') #igual
plt.xlim(8.2,12.4)
plt.xlabel("Freq(GHz)")
plt.xlabel("Impedance(a.u)")
plt.title("Impedance")
plt.legend().get_frame().set_facecolor('0.95')
...
plt.plot(F_grafic,N,'-g',label ='n_analitico')
plt.plot(F_grafic,Na,'-r',label ='n_calculado_Par-S') 
plt.xlim(8.2,12.4)
plt.xlabel("Freq(GHz)")
...
plt.xlim(8.2,12.4)
plt.xlabel("Freq(GHz)")
plt.ylabel("Relative Permissivity")
